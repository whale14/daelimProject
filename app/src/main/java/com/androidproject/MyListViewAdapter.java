...
public class MyListViewAdapter  extends BaseAdapter {
    ...
    private ArrayList<MyListView> listViewItemList = new ArrayList<MyListView>() ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView myDay = (TextView) convertView.findViewById(R.id.myDay) ;

        // Data Set(listViewItemList)에서 position에 위치한 데이터 참조 획득
        MyListView listViewItem = listViewItemList.get(position);

        // 아이템 내 각 위젯에 데이터 반영
        myImg.setImageDrawable(listViewItem.getIcon());
        myTitle.setText(listViewItem.getTitle());
        myDay.setText(listViewItem.getDesc());
